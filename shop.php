...
<head>
	<meta charset="utf-8" />
	<title>Sklep</title>
	<meta name="description" content="Wesprzyj mnie" />
	<meta name="keywords" content="sklep, upominki, prezenty, dziennikarstwo" />
	...
	<form>
	<input type="text" name="shop-searchquery" class="shop-searchbox" placeholder="Czego szukasz?" size=25 />
	<form>
